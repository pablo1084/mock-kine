...
export function HeroSection({ hidden }) {
  return (
    <section id="inicio" className={`${hidden ? 'hidden' : ''} relative isolate overflow-hidden bg-[#15181b] pt-24 text-white`}>
      ...
      <div className="hero-layout relative mx-auto grid max-w-7xl items-center gap-8 px-4 pb-10 pt-8 sm:gap-10 sm:px-6 sm:pb-12 lg:static lg:grid-cols-2 lg:gap-0 lg:px-8 lg:py-10">
        <div className="relative z-10 min-w-0 py-2 lg:py-6 lg:pr-6">
